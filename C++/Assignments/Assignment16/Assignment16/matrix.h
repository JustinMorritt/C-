...
public:
	...
	std::vector<std::vector<double>> minor(Matrix& m, unsigned row);
	std::vector<double> TrimVector(std::vector<double>& vec, unsigned exclude);
	std::vector<double> MultVectors(std::vector<double>& vec, int i);
	std::vector<double> AddVectors(std::vector<double>& vec1, std::vector<double>& vect2);
	void SetRowVector(std::vector<double> vec, unsigned i);
